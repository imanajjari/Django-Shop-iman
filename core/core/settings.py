...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-za$-%p^k32hia-#&%_7qi^=e911(#2&veg8%rypavsn84^*duf')
...
EMAIL_PORT = config('EMAIL_PORT', cast=int, default=25)   # SMTP server port
